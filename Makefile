.PHONY: all lint test test-cov viz-alpha-correlation viz-alpha-group-significance install dev clean distclean

all: viz-alpha-correlation viz-alpha-group-significance
